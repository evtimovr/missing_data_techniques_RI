...
bla <- as.data.frame(df_results)
combinations_df <- as.data.frame(combinations)
combinations_df_3 <- as.data.frame(combinations)
filename = paste("results_big", 2,".csv")
write.csv(bla, filename)
combinations_df_3$mu_g_list <- sapply(combinations_df_3$mu_g_list, paste, collapse = ", ")
combinations_df_3$mu_b_list <- sapply(combinations_df_3$mu_b_list, paste, collapse = ", ")
combinations_df_3$sigma_g_list <- sapply(combinations_df_3$sigma_g_list, paste, collapse = ", ")
combinations_df_3$sigma_b_list <- sapply(combinations_df_3$sigma_b_list, paste, collapse = ", ")
write.csv(combinations_df_3, "combinations_3.csv")
